...
package eu.depau.etchdroid.libdepaums.driver.scsi.commands;
...
public abstract class CommandBlockWrapper {
	 ...
	 *            {@link CommandBlockWrapper.Direction #NONE
	 *            NONE}
	 * @param lun
	 ...
	 * @see CommandBlockWrapper.Direction
	 *      Direction
	 */
