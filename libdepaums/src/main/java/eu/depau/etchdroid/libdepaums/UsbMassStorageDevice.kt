...
package eu.depau.etchdroid.libdepaums
...
import eu.depau.etchdroid.libdepaums.driver.BlockDeviceDriverFactory
import eu.depau.etchdroid.libdepaums.partition.Partition
...
import eu.depau.etchdroid.libdepaums.usb.UsbCommunication
import eu.depau.etchdroid.libdepaums.usb.UsbCommunicationFactory
 ...
 * [eu.depau.etchdroid.libdepaums.partition.Partition]).
 *
 *
...
private constructor(
     ...
     * [eu.depau.etchdroid.libdepaums.usb.HoneyCombMr1Communication]
     * or (
     * [eu.depau.etchdroid.libdepaums.usb.JellyBeanMr2Communication]
     * ).
     *
